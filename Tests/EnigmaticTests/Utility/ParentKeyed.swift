class ParentKeyed: Codable {
  ...
  final class DefaultKeyedChild: ParentKeyed, Equatable {
    var string: String
  ...
  final class CustomKeyedChild: ParentKeyed, Equatable {
    var string: String
  ...
  final class ValueUnkeyedChild: ParentKeyed, Equatable {
    var string: String
  ...
  final class ArrayUnkeyedChild: ParentKeyed, Equatable {
    var strings: [String]
