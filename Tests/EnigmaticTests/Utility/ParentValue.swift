class ParentValue: Codable {
  ...
  final class DefaultKeyedChild: ParentValue, Equatable {
    var string: String
  ...
  final class CustomKeyedChild: ParentValue, Equatable {
    var string: String
  ...
  final class ValueUnkeyedChild: ParentValue, Equatable {
    var string: String
  ...
  final class ArrayUnkeyedChild: ParentValue, Equatable {
    var strings: [String]
